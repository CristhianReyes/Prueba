...
class TextBox(View):
    ...
    def append_text_with_encoding_and_scroll(self, text, encoding, scroll_to_end=False):
...
class TabView(View):
    ...
    def add_page(self, page, caption):
        return _mforms.TabView_add_page(self, page, caption)
...
class Box(Container):
    ...
    def add(self, subview, expand, fill=False):
        return _mforms.Box_add(self, subview, expand, fill)

    def add_end(self, subview, expand, fill=False):
...
_mforms.SystemColorHighlight_swigconstant(_mforms)
SystemColorHighlight = _mforms.SystemColorHighlight

_mforms.SystemColorEditor_swigconstant(_mforms)
SystemColorEditor = _mforms.SystemColorEditor

_mforms.SystemColorDisabled_swigconstant(_mforms)
SystemColorDisabled = _mforms.SystemColorDisabled

_mforms.SystemColorContainer_swigconstant(_mforms)
...
class App(DockingPoint):
    ...
    def get_system_color(self, type):
        return _mforms.App_get_system_color(self, type)
...
class DrawBox(View):
    ...
    def get_layout_size(self):
        return _mforms.DrawBox_get_layout_size(self)
...
class MenuItem(MenuBase):
    ...
    def set_validator(self, slot):
        return _mforms.MenuItem_set_validator(self, slot)
...
class Splitter(Container):
    ...
    def set_position(self, position):
        return _mforms.Splitter_set_position(self, position)

    def get_position(self):
        return _mforms.Splitter_get_position(self)
...
class CodeEditor(View):
    ...
    def set_font(self, fontDescription):
        return _mforms.CodeEditor_set_font(self, fontDescription)
...
class TreeNodeView(View):
    ...
    def __init__(self, options):
        this = _mforms.new_TreeNodeView(options)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def add_column(self, type, name, initial_width, editable=False, attributed=False):
        return _mforms.TreeNodeView_add_column(self, type, name, initial_width, editable, attributed)

    def end_columns(self):
        return _mforms.TreeNodeView_end_columns(self)

    def set_column_title(self, column, title):
        return _mforms.TreeNodeView_set_column_title(self, column, title)

    def set_row_overlay_handler(self, overlay_icon_for_node):
        return _mforms.TreeNodeView_set_row_overlay_handler(self, overlay_icon_for_node)

    def get_column_count(self):
        return _mforms.TreeNodeView_get_column_count(self)

    def get_column_type(self, column):
        return _mforms.TreeNodeView_get_column_type(self, column)

    def clear(self):
        return _mforms.TreeNodeView_clear(self)

    def root_node(self):
        return _mforms.TreeNodeView_root_node(self)

    def add_node(self):
        return _mforms.TreeNodeView_add_node(self)

    def set_selection_mode(self, mode):
        return _mforms.TreeNodeView_set_selection_mode(self, mode)

    def get_selection_mode(self):
        return _mforms.TreeNodeView_get_selection_mode(self)

    def get_selection(self):
        return _mforms.TreeNodeView_get_selection(self)

    def get_selected_node(self):
        return _mforms.TreeNodeView_get_selected_node(self)

    def get_selected_row(self):
        return _mforms.TreeNodeView_get_selected_row(self)

    def clear_selection(self):
        return _mforms.TreeNodeView_clear_selection(self)

    def select_node(self, node):
        return _mforms.TreeNodeView_select_node(self, node)

    def set_node_selected(self, node, flag):
        return _mforms.TreeNodeView_set_node_selected(self, node, flag)

    def row_for_node(self, node):
        return _mforms.TreeNodeView_row_for_node(self, node)

    def node_at_row(self, row):
        return _mforms.TreeNodeView_node_at_row(self, row)

    def node_at_position(self, position):
        return _mforms.TreeNodeView_node_at_position(self, position)

    def node_with_tag(self, tag):
        return _mforms.TreeNodeView_node_with_tag(self, tag)

    def set_row_height(self, height):
        return _mforms.TreeNodeView_set_row_height(self, height)

    def set_allow_sorting(self, flag):
        return _mforms.TreeNodeView_set_allow_sorting(self, flag)

    def freeze_refresh(self):
        return _mforms.TreeNodeView_freeze_refresh(self)

    def thaw_refresh(self):
        return _mforms.TreeNodeView_thaw_refresh(self)

    def set_column_visible(self, column, flag):
        return _mforms.TreeNodeView_set_column_visible(self, column, flag)

    def get_column_visible(self, column):
        return _mforms.TreeNodeView_get_column_visible(self, column)

    def set_context_menu(self, menu):
        return _mforms.TreeNodeView_set_context_menu(self, menu)

    def set_header_menu(self, menu):
        return _mforms.TreeNodeView_set_header_menu(self, menu)

    def get_context_menu(self):
        return _mforms.TreeNodeView_get_context_menu(self)

    def get_header_menu(self):
        return _mforms.TreeNodeView_get_header_menu(self)

    def get_clicked_header_column(self):
        return _mforms.TreeNodeView_get_clicked_header_column(self)

    def get_column_width(self, column):
        return _mforms.TreeNodeView_get_column_width(self, column)

    def set_column_width(self, column, width):
        return _mforms.TreeNodeView_set_column_width(self, column, width)

    def count(self):
        return _mforms.TreeNodeView_count(self)

    def add_activated_callback(self, callback):
        return _mforms.TreeNodeView_add_activated_callback(self, callback)

    def call_activated_callback(self, i, j):
        return _mforms.TreeNodeView_call_activated_callback(self, i, j)

    def add_changed_callback(self, callback):
        return _mforms.TreeNodeView_add_changed_callback(self, callback)

    def call_changed_callback(self):
        return _mforms.TreeNodeView_call_changed_callback(self)

    def add_column_resized_callback(self, callback):
        return _mforms.TreeNodeView_add_column_resized_callback(self, callback)

    def call_column_resized_callback(self, i):
        return _mforms.TreeNodeView_call_column_resized_callback(self, i)

    def set_cell_edited_callback(self, callable):
        return _mforms.TreeNodeView_set_cell_edited_callback(self, callable)

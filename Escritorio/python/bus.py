...
def Inserta(en, ti, des):
    query = "INSERT INTO pages(enlace,titulo,descripcion) VALUES ('%s','%s','%s')" % (en,ti,des) #Insert Into Paginas *Paginas* es mi tabla y enlace,tutulo y descripcion mis atributos, cada (%s) es la cantidad de valores que se van a ingresar, luego se pone %(con los valores que representan cada %s)
    run_query(query)
